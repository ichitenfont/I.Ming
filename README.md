...
* [「一點明體」（I.Ming）](8.10/I.Ming-8.10.ttf)：收錄力求遵從字理的傳承字形。
* [「一點明體CP」（I.MingCP）](8.10/I.MingCP-8.10.ttf)：與「一點明體」一樣，唯全形標點置中。
* [「一點明體異體」（I.MingVar）](8.10/I.MingVar-8.10.ttf)：部份漢字改爲收錄一些也常見，但字理上未必比上者佔優的傳承字形。
* [「一點明體異體CP」（I.MingVarCP）](8.10/I.MingVarCP-8.10.ttf)：與「一點明體異體」一樣，唯全形標點置中。
* [「新一細明體」（PMingI.U）](8.10/PMingI.U-8.10.ttf)：與「一點明體CP」一樣，唯行高修改至跟Windows系統細明體相同。
* [「新一細明體異體」（PMingI.UVar）](8.10/PMingI.UVar-8.10.ttf)：與「一點明體異體CP」一樣，唯行高修改至跟Windows系統細明體相同。

此外，在[「I.明體」8.10版的文件夾](8.10/)內，尚有「I.明體」計劃的說明檔、字型功能的說明檔、版權授權條款檔、字型歷次變更的詳細紀錄檔。
